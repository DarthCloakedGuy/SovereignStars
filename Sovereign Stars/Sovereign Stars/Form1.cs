...
namespace Sovereign_Stars
{
    public partial class Form1 : Form
    {
        ...
        public void drawBackground(Graphics tool)
        {
        ...
        public void drawGrid(Graphics tool)
        {
        ...
        public void drawNode(MapNode obj, Graphics tool)
        {
            ...
            if (!obj.distort)
            {
                for (int k = 0; k < 360; k += 60)
                {
                    ...
                    double xdist = hypotenuse * (Math.Cos(Globals.DegToRad(angle))) / 3.0;
                    double ydist = hypotenuse * (Math.Sin(Globals.DegToRad(angle))) / 3.0;
                    double xdist2 = hypotenuse * (Math.Cos(Globals.DegToRad(angle - (double)60))) / 3.0;
                    double ydist2 = hypotenuse * (Math.Sin(Globals.DegToRad(angle - (double)60))) / 3.0;
        ...
        public void drawSystem()
        {
            ...
            for (int k = 0; k < 360; k += 5)
            {
                ...
                drawTools.DrawLine(new Pen((Brushes.Blue), 1),
        ...
        public void drawCursor()
        {
            ...
            if (mousePos.Active)
            {
                ...
                drawTools.DrawLine(new Pen((Brushes.Red), 2),
        ...
        public void drawPath()
        {
            if (mousePos.Active)
            {
                ...
                {
                    drawTools.DrawLine(new Pen((Brushes.Yellow), 2),
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            pictureBox1.BackgroundImage = layers;
